...
class Application():
    def __init__(self,master,*args,**kwargs):
        ...
        #components
        self.heading=Label(self.left,text="NMIMS'S STORE",font=('arial 40 bold'),fg='steelblue',)
        ...
        #enter stuff
        self.enterid=Label(self.left,text="Enter Product's ID",font=('arial 18 bold'),fg='steelblue',)
        ...
        self.productname=Label(self.left,text="",font=('arial 27 bold'),bg='white',fg='white')
        self.productname.place(x=0,y=250)

        self.pprice = Label(self.left, text="", font=('arial 27 bold'), bg='white', fg='white')
    ...
    def ajax(self,*args,**kwargs):
        ...
        if self.pc:
          ...
          self.productname.configure(text="Product's Name: " +str(self.get_name),fg='steelblue')
          self.pprice.configure(text="Price:RS. "+str(self.get_price),fg='steelblue')


        #craete the quantity and the discount label
          self.quantityl=Label(self.left,text="Enter Quantity",font=('arial 18 bold'),fg='steelblue')
        ...
        #discount
          self.discount_l = Label(self.left, text="Enter Discount", font=('arial 18 bold'),fg='steelblue')
        ...
        #genrate bill and change
          self.change_l=Label(self.left,text="Given Amount",font=('arial 18 bold'),fg='steelblue')
